...
alias gl='git log --graph --decorate --max-count 15 --pretty=format:"%C(yellow)%h%Creset %C(green)%ad%Creset | %s%C(bold red)%d%Creset [%C(bold blue)%an%Creset]" --date=short'
alias gla='git log --graph --decorate --pretty=format:"%C(yellow)%h%Creset %C(green)%ad%Creset | %s%C(bold red)%d%Creset [%C(bold blue)%an%Creset]" --date=short'
alias gf='git fetch'
alias gp='git pull'
alias gpu='git push'
alias gs='git status'
